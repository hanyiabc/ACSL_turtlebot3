...
\includegraphics[width=0.7\linewidth]{images/DC_power_cable.jpg}\\
...
%\lstinputlisting[style=C++, firstline=20, lastline=32]{src/main.cpp}
...
%\lstinputlisting[style=C++, firstline=29, lastline=29]{src/main.cpp}
...
%\lstinputlisting[style=C++, firstline=28, lastline=28]{src/main.cpp}
...
%\lstinputlisting[style=C++, firstline=156, lastline=157]{src/main_window.cpp}
...
%\lstinputlisting[style=C++, firstline=162, lastline=163]{src/main_window.cpp}
...
%\lstinputlisting[style=C++, firstline=82, lastline=83]{src/main_window.cpp}
...
%\lstinputlisting[style=C++, firstline=89, lastline=89]{src/main_window.cpp}
